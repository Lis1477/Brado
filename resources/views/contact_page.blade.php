...
{{-- @include('includes.url_line') --}}
        ...
        <div class="text-block">
            ...
            <address>Республика Беларусь, 220015, г.Минск, ул.Пономаренко 41, офис 206</address>
        ...
        <div class="text-block">
            ...
            <address>Республика Беларусь, г.Минск, ул. Рогачевская, 14<br>
            (Примечание: фактический адрес в Яндекс и Google картах определять как ул. Основателей, 27)<br>
            <a href="{{ asset('/files/route_schema_2022.pdf') }}" target="_blank" title="Жми, чтобы скачать">Скачать схему проезда</a><br>
            Координаты для навигатора: 53.945328, 27.732426</address>
